...
void protocol::prepare_ft_header(message* msg, uint64_t seq, uint64_t ack, uint64_t msg_id, uint16_t wnd, bool fini){
...
void protocol::prepare_ack_pkt(message* msg, uint64_t ack, uint16_t wnd, bool is_sack){
