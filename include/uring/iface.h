...
struct client_iface : iface_base {
  ...
  int prepare_recv() { return add_recv(this, fd, slt); }
  ...
  int handle_cqe(struct io_uring_cqe *cqe, auto &&f) {
    ...
    case 1:
      ...
      return process_cqe_recv(this, cqe, fd, untag(cqe->user_data), f);
    }
    return 0;
  }
